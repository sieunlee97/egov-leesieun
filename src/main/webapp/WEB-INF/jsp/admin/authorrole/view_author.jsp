    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row"><!-- 부트스트랩의 디자인 클래스 row -->
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="${result.ROLE_PTTRN}" type="text" class="form-control" name="ROLE_PTTRN" id="ROLE_PTTRN" placeholder="화면 URL을 입력해주세요." required>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input value="${result.AUTHORROLE_DC}" type="text" class="form-control" name="AUTHORROLE_DC" id="AUTHORROLE_DC" placeholder="권한 설명을 입력해주세요." required>
                  </div>
                  <div class="form-group">
                    <label for="SORT_ORDR">SORT_ORDR</label>
                    <input value="${result.SORT_ORDR}" type="text" class="form-control" name="SORT_ORDR" id="SORT_ORDR" placeholder="권한 적용 순서를 입력해주세요." required>
                  </div>
                  <div class="form-group">
                  	<label for="USE_AT">USE_AT</label>
                  	<div class="form-check">
               		<input class="form-check-input" type="radio" name="USE_AT" id="USE_Y" value="Y" <c:out value="${(result.USE_AT eq 'Y')? 'checked':'' }" />>
               		<label class="form-check-label" for="USE_Y">사용</label>
               		<span style="display:inline-block; width:20px;"></span>
               		<input class="form-check-input" type="radio" name="USE_AT" id="USE_N" value="N" <c:out value="${(result.USE_AT eq 'N')? 'checked':'' }" />>
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
              	<a href="<c:url value='/admin/authorrole/list_author.do?pageVO=${pageVO.page}&search_type=${pageVO.search_type}&search_keyword=${pageVO.search_keyword}' />" class="btn btn-primary float-right mr-1">목록</a>              	

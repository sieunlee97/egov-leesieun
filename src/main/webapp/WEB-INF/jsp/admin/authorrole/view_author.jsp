              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input value="${ROLE_PTTRN}" type="text" class="form-control" name="ROLE_PTTRN" id="ROLE_PTTRN" placeholder="화면 URL을 입력해주세요." required>
                  ...
                  <div class="form-group">
                    ...
                    <input value="${AUTHOR_CODE}"type="text" class="form-control" name="AUTHOR_CODE" id="AUTHOR_CODE" placeholder="권한 코드를 입력해주세요." required>
                  </div>
                   <div class="form-group">
                    <label for="AUTHORROLE_DC">AUTHORROLE_DC</label>
                    <input value="${AUTHORROLE_DC}" type="text" class="form-control" name="AUTHORROLE_DC" id="AUTHORROLE_DC" placeholder="권한 설명을 입력해주세요." required>
                  </div>
                  <div class="form-group">
                    <label for="SORT_ORDR">SORT_ORDR</label>
                    <input value="${SORT_ORDR}" type="text" class="form-control" name="SORT_ORDR" id="SORT_ORDR" placeholder="권한 적용 순서를 입력해주세요." required>
                  </div>
                  <div class="form-group">
                  	<label for="USE_AT">USE_AT</label>
                  	<input value="${USE_AT}" type="text" class="form-control" name="USE_AT" id="USE_AT" placeholder="이름을 입력해주세요." required>

              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <c:forEach items="${listMember}" var="memberVO">
                    <tr>
                      <td><a href="<c:url value='/admin/member/view_member.do?emplyr_id=${memberVO.EMPLYR_ID}&amp;pageVO=${pageVO.page}&amp;search_type=${pageVO.search_type}&amp;search_keyword=${pageVO.search_keyword}' />">${memberVO.EMPLYR_ID}</a></td> <!-- table data 태그 -->

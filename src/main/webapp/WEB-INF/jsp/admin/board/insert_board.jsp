  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">${bdMstr.bbsNm} 게시물등록</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">${bdMstr.bbsNm} 게시물등록</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nttSj" id="nttSj" placeholder="제목 입력해주세요." required>
                  ...
                  <!-- label for과 textarea id는 같게 설정 -->
					...
					<textarea row="5" name="nttCn" id="nttCn" class="form-control"></textarea>
                  </div>
                  <div class="form-group">
                  	<label for="frstRegisterNm">writer</label>
                  	<input disabled value="${LoginVO.name}" type="text" class="form-control" name="frstRegisterNm" id="frstRegisterNm" placeholder="작성자을 입력해주세요." required />
          ...
          <!-- 버튼영역 시작 -->
            <div class="card-body">
            	<button id="btn_list" type="button" class="btn btn-primary float-right mr-1">목록</button>            	
              	<button type="submit" class="btn btn-warning float-right mr-1 text-white">등록</button>
...
<script>
$(document).ready(function(){
	var update_form = $("form[name='insert_form']");

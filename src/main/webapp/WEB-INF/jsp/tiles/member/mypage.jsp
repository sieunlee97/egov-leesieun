		...
		<div class="bodytext_area box_inner">
			...
			<form method="POST" name="mypage_form" action="<c:url value='/' />tiles/mypage.do" class="appForm">
				<fieldset>
					...
					<ul class="app_list">
						<li class="clear">
							...
							<div class="app_content">
								<input value="${memberVO.EMPLYR_ID}" type="text" name="EMPLYR_ID" class="w100p" id="EMPLYR_ID" placeholder="아이디를 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content">
								<input value="${memberVO.PASSWORD_HINT}" type="text" name="PASSWORD_HINT" class="w100p" id="password_hint_lbl" placeholder="암호 힌트를 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
							<label for="password_cnsr_lbl" class="tit_lbl pilsoo_item">힌트 답변</label>
							<div class="app_content">
								<input value="${memberVO.PASSWORD_CNSR}" type="text" name="PASSWORD_CNSR" class="w100p" id="password_cnsr_lbl" placeholder="힌트 답변을 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
							<label for="user_nm_lbl" class="tit_lbl pilsoo_item">이름</label>
							<div class="app_content">
								<input value="${memberVO.USER_NM}" type="text" name="USER_NM" class="w100p" id="name_nm_lbl" placeholder="이름을 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
						...
						<li class="clear">
							...
							<div class="app_content">
								<input value="${memberVO.EMAIL_ADRES}" type="email" name="EMAIL_ADRES" class="w100p" id="email_adres_lbl" placeholder="이메일을 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
							<label for="house_adres_lbl" class="tit_lbl pilsoo_item">주소</label>
							<div class="app_content">
								<input value="${memberVO.HOUSE_ADRES}" type="text" name="HOUSE_ADRES" class="w100p" id="house_adres_lbl" placeholder="주소를 입력해주세요" required/>
							</div>
						</li>
						<li class="clear">
					...
					<p class="btn_line">
					<button type="submit" class="btn_baseColor">정보 수정</button>
					<button id="btn_delete" type="button" class="btn_baseColor">회원 탈퇴</button>
					</p>	
				</fieldset>
